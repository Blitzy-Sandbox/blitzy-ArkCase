...
`https://devXXXXXX.service-now.com` — you will have:
...
```bash
export SERVICENOW_INSTANCE_URL="https://devXXXXXX.service-now.com"   # your target PDI
...
> CR3 F12 note above this table was written while step 1 still offered three superseded child counts and says
> the row is "retained as written". Because an operator executes the row before reading anything around it, the
