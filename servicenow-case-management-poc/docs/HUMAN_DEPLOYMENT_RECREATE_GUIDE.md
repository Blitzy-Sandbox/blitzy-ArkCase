...
> complete round trip has never been run); it was described here as the **available upgrade path**, with §5 run
...
> **required as written**, and the child count to assert on upload is **935**, not 988 and not 926.
