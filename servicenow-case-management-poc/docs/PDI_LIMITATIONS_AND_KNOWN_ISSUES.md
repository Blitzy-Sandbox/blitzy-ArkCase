...
> what the deliverable IS is 522 blocks / 2,994,341 bytes / `751ceb61…`, MEASURED, NOT GATE-VERIFIED — see the
...
> F12): Gate 7 is OPEN.** The bytes that ship (`751ceb61…`, 2,994,341 bytes) have never been uploaded,
...
> the
> **available upgrade path**: it satisfies AAP §0.5.2 dependency ordering and carries the platform-captured **[CR3 2026-09-09 · F13 — NOT A TARGET: the package named here was deleted on 2026-09-08, is not on disk, and may not be uploaded, verified, gated, selected or promoted; no 988- or 935-child count may be asserted. The only such target is `update-set/x_casemgmt_case_management_update_set.xml` — 522 blocks / 2,994,341 bytes / `751ceb61…`, itself ungated. Retained as provenance only.]**
> schema records and all 27 role links, and §10.0 item 1a stated the single run that would promote it back to
> the deliverable path. **[CR3 2026-09-09 · F13 — NOT A TARGET: that file was deleted on 2026-09-08, is not on disk, and there is no promotion to perform. The only upload, verification or promotion target is the canonical path, `update-set/x_casemgmt_case_management_update_set.xml` — 522 children, SHA-256 `751ceb61…`.]**  **This splits three ways, and every part matters.** *(1) What was verified live:* those 988
> records
...
The bytes that ship (522 blocks / 2,994,341 bytes / `751ceb61…`) have never been uploaded, previewed or
...
**CORRECTED 2026-09-08 — the most recent live suite result is `TES0001006`.** **CORRECTED 2026-09-09 (CR3 F12/F18): that result was taken on the artifacts the 2026-09-08 revision's commit created (`b2217224…`), not on the bytes that ship.** No ATF suite run and no transition-harness run covers the shipping 522-block / 2,994,341-byte / `751ceb61…` file, which has never been uploaded, previewed or committed. The
...
>
> **CORRECTED 2026-09-08 — a package-alone figure exists: take `TES0001006`.** **CORRECTED 2026-09-09 (CR3 F12/F18): that result was taken on the artifacts the 2026-09-08 revision's commit created (`b2217224…`), not on the bytes that ship.** No ATF suite run and no transition-harness run covers the shipping 522-block / 2,994,341-byte / `751ceb61…` file, which has never been uploaded, previewed or committed. On
...
path now measures **2,994,341** bytes / SHA-256 `751ceb61…` and has never been uploaded, previewed or
...
> RE-VERDICTED 2026-09-09 (CR3 F12): it has NOT been run on the bytes that ship now (2,994,341 / `751ceb61…`),
...
> 100%*, and those bytes are superseded by the ungated `751ceb61…` file**. Both candidate packages were superseded and **deleted**, so there is no promotion left to make. Full
...
to quote.** **CORRECTED 2026-09-09 (CR3 F12/F18): that result was taken on the artifacts the 2026-09-08 revision's commit created (`b2217224…`), not on the bytes that ship.** No ATF suite run and no transition-harness run covers the shipping 522-block / 2,994,341-byte / `751ceb61…` file, which has never been uploaded, previewed or committed. Against the consolidated 522-block export (`b2217224…`), committed once natively onto an instance
