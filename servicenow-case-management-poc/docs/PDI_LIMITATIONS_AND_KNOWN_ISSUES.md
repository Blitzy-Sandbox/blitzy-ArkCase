...
present, and every failure traces to the absent persona role grants rather than to the choice defect. [`refine-run/CONSOLIDATION-FINAL-REPORT.md`](./refine-run/CONSOLIDATION-FINAL-REPORT.md).
