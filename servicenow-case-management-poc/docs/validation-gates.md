...
> rollback clean, demo census back to 10 / 10 / 8). This gate therefore does **not** pass on the package alone
> today, and the six named failures are not to be averaged into a rate.
