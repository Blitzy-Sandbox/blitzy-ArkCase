...
> has been hibernating since 2026-08-11 and serves no application surface, so nothing here has been re-measured
> since; [`PDI_LIMITATIONS_AND_KNOWN_ISSUES.md` §0.11](./PDI_LIMITATIONS_AND_KNOWN_ISSUES.md) records what that
> leaves unproven.
