...
| Folded into the package | **761 of the package's 913** `<sys_update_xml>` blocks in `update-set/x_casemgmt_case_management_update_set.xml` (3,614,359 bytes, SHA-256 `c04656b4…`) — the suite is the single largest thing in the deliverable |
