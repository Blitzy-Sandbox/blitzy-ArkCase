...
- **The ATF suite runs end to end, and the current verdict is 14 of 20 — not green.** The latest run is
  ...
  Defect C's choice half, the outstanding item recorded at the top of this README, and each failure's failing
