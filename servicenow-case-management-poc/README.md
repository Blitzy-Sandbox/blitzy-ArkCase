...
- **Identity:** `update-set/x_casemgmt_case_management_update_set.xml` — **988 update blocks, 4,062,436 bytes,
  SHA-256 `90ee024968f29a36f420eeeea908676054bc0d79067ff8d26e826662d78d35d7`**, the native-rebuild package.
  **Verify the artifact against that digest; do not read it as a verified-by-round-trip digest.** The preview
...
> **These four steps are the AAP's deployment contract, reproduced as written. On the package that ships today
> they are sufficient — and step 2 is the step still owed on the exact shipping byte sequence (item 4 of the
> note at the top of this file).** The 2026-09-02 native-rebuild run committed those 988 records once on a clean
